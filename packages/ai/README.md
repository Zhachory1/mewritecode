...
```bash
npm install @zhachory1/mewrite-ai
```

TypeBox exports are re-exported from `@zhachory1/mewrite-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@zhachory1/mewrite-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@zhachory1/mewrite-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@zhachory1/mewrite-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@zhachory1/mewrite-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@zhachory1/mewrite-ai';
...
```typescript
import { getModel, stream } from '@zhachory1/mewrite-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@zhachory1/mewrite-ai';
...
```typescript
import { Model, stream } from '@zhachory1/mewrite-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@zhachory1/mewrite-ai';
...
```typescript
import { getModel, complete, Context } from '@zhachory1/mewrite-ai';
...
```typescript
import { Context, getModel, complete } from '@zhachory1/mewrite-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@zhachory1/mewrite-ai/oauth` entry point in Node.js.
...
npx @zhachory1/mewrite-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@zhachory1/mewrite-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@zhachory1/mewrite-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@zhachory1/mewrite-ai/oauth';
...
```typescript
import { getModel, complete } from '@zhachory1/mewrite-ai';
import { getOAuthApiKey } from '@zhachory1/mewrite-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@zhachory1/mewrite-ai`
