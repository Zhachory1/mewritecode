...
- When the user asks what you remember or asks to use remembered knowledge, search durable memory through Me Write memory tools and the configured backend.
- When the user asks to capture, remember, save learning, or write durable notes/docs, use Me Write memory tools and the configured backend/filing rules. If no memory backend or rules are available, ask where to write before persisting.
