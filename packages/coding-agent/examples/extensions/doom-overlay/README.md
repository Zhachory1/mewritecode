...
Play DOOM as an overlay in Me Write Code. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
mewrite --extension ./examples/extensions/doom-overlay
```
...
- the original DOOM terminal integration this example was adapted from
