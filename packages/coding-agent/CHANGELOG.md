...
- Added native Ponytail code-minimalism mode, enabled by default with `/ponytail` session controls and `ponytail.enabled`/`ponytail.intensity` settings ([#46](https://github.com/Zhachory1/mewritecode/issues/46), [#56](https://github.com/Zhachory1/mewritecode/issues/56)).
